// node_modules/@gabrielevierti/glyph/lib/frame-CT1__Sfi.js
var W = 16;
var tt = 17;
function w(c) {
...
var V = { width: 1, cap: "round", join: "round", alpha: 1 };
function P(c) {
...
var E = class _E {
  ...
  constructor(t = {}) {
    ...
    const e = this.canvas.getContext("2d", { alpha: false, willReadFrequently: true });
  ...
  ring(t, e, s, i, h = 0, a = Math.PI * 2, n) {
    return this.scoped(() => {
      this.ctx.beginPath(), this.ctx.arc(t, e, s, h, a), this.ctx.arc(t, e, i, a, h, true), this.ctx.closePath(), this.fillAndStroke(this.paint(n, 15));
    });
  }
  quad(t, e, s, i, h, a, n) {
    return this.scoped(() => {
  ...
  blit(t, e, s, i, h) {
    ...
    return r.data.set(H(t)), n.putImageData(r, 0, 0), this.scoped(() => {
      this.ctx.imageSmoothingEnabled = false, this.ctx.drawImage(a, Math.round(i), Math.round(h), e, s);
    });
  }
  /** Compose another raster onto this one. */
  drawRaster(t, e = 0, s = 0, i = 1) {
    return this.scoped(() => {
      this.ctx.globalAlpha = i, this.ctx.imageSmoothingEnabled = true, this.ctx.drawImage(t.element, e, s, t.width, t.height);
    });
  }
  /**
  ...
  textBox(t, e, s = {}, i = 15, h = {}) {
    const a = h.hAlign ?? "left", n = h.vAlign ?? "top", r = j(s), o = h.maxLines ?? Math.max(1, Math.floor(e.height / r)), l = h.wrap === false ? [Y(this.measure, t, s, e.width)] : D(this.measure, t, s, e.width, o), u = l.length * r, x = n === "top" ? e.y : n === "bottom" ? e.y + e.height - u : e.y + (e.height - u) / 2, g = a === "left" ? e.x : a === "right" ? e.x + e.width : e.x + e.width / 2;
...
var $ = 4;
var d = (c, t, e, s, i) => ({ id: c, name: `t${c - 10}`, x: t, y: e, width: s, height: i, zOrder: c - 9 });
var I = {
  name: "quadrants",
...
//# sourceMappingURL=chunk-CJM4VOZO.js.map

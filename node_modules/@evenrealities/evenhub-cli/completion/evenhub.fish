...
complete -c evenhub -n "__fish_evenhub_using_subcommand pack" -l sdk-ver -d 'SDK version you built against' -r
...
complete -c evenhub -n "__fish_evenhub_using_subcommand pack" -l enforce-manual-version -d 'Stamp min_app_version from app.json as-is'
